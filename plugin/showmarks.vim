...
if !hasmapto( '<Plug>ShowmarksShowMarksToggle' ) | nnoremap <silent> <unique> m? :ShowMarksToggle<cr>|    endif
if !hasmapto( '<Plug>ShowmarksShowMarksOn'     ) | nnoremap <silent> <unique> m! :ShowMarksOn<cr>|        endif
if !hasmapto( '<Plug>ShowmarksClearMark'       ) | nnoremap <silent> <unique> m; :ShowMarksClearMark<cr>| endif
if !hasmapto( '<Plug>ShowmarksClearAll'        ) | nnoremap <silent> <unique> m<Space> :ShowMarksClearAll<cr>|  endif
if !hasmapto( '<Plug>ShowmarksPlaceMark'       ) | nnoremap <silent> <unique> m, :ShowMarksPlaceMark<cr>| endif
...
hi default ShowMarksHLl ctermfg=darkblue ctermbg=black cterm=inverse,bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLu ctermfg=darkblue ctermbg=black cterm=inverse,bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLo ctermfg=lightblue ctermbg=black cterm=bold guifg=blue guibg=lightblue gui=bold
