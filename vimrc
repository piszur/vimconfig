...
nmap <Leader><Leader><Return> :execute (split(expand("%:p"),"/")[4] == "src") ? "NERDTreeFind"." /".join(split(expand('%:p'),"/")[0:5],"/")."/" : "NERDTreeToggle"<CR>
nmap <Leader><Leader><Leader><Return> :NERDTreeToggle<CR>
